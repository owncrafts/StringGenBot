...
async def generate_session(bot: Client, msg: Message, telethon=False, old_pyro: bool = False, is_bot: bool = False):
    ...
    text = f"**This is your {ty} string session**\n\n👉 `{string_session}`\n\n**🔰 Note: **\n\n1. `Don't share it with anyone even if that person is your girlfriend.`\n2. `Save this string session for safe place.`\n3. `You only use this string session only 1 time.`\n4. `If you are using this for developing userbot then we won't take any responsibility.`\n5. `Use this string session only at safe place where you can believe.`\n\n✅ **Generated by @Stringsession_officialbot**\n**✅ Join: @DCvsMARVELchannel**"
    try:
        if not is_bot:
